...
from ..shared import appliedaddon as shared_appliedaddon
from typing import Optional


@dataclasses.dataclass
class ApplyAddOnResponse:
    ...
    applied_add_on: Optional[shared_appliedaddon.AppliedAddOn] = dataclasses.field(default=None)
